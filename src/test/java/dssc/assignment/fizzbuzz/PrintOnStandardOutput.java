...
public class PrintOnStandardOutput {
    ...
    void numbers_from_1_to_100 () {
        ...
        fizzBuzz.print();
        assertEquals(FIZZBUZZEZ_from_1_to_100, fakeStandardOutput.toString());
    }
